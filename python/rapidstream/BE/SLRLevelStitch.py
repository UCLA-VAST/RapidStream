...
def setupTopStitch():
  ...
  get_cmd = lambda tool: f'source {args.rw_stitch_setup_path} && java -Xmx100g com.xilinx.rapidwright.examples.MergeDCP {slr_stitch_dir}/{tool} top_stitch.dcp ".*routed_slr_\d.*dcp"'
