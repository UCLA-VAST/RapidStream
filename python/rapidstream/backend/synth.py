...
def get_synth_script(
  ...
  script.append(f'set WRAPPER_PATH "{wrapper_rtl_dir}/{slot_name}/rtl"')
  ...
  # clock xdc
  script.append(f'read_xdc "{wrapper_rtl_dir}/clock.xdc"')
